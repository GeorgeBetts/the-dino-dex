...
export interface DinosaurCardProps
  ...
  dinosaur: Dinosaur;
  href?: string; // Optional link target for the view button
  onView?: (dino: Dinosaur) => void; // Optional click handler
}
    ...
    >
      ...
      <div className="flex flex-col gap-3 p-4 grow">
        <div>
          <Text
            as="h4"
            className="text-emerald-800 font-semibold tracking-wide"
          >
            {dinosaur.taxon}
          </Text>
          {taxon && (
